  ...
  const footerHTML = `
    <footer>
      <div class="footer-credit" aria-label="Developed by credit">
        Developed, Designed and Maintained with <span class="heart">❤</span> by <strong><span class="blinking-text">Niloy Pandit</span></strong> |
 ...
 // Add a hover message for Admin Tools
  ...
  if (adminTools) {
    adminTools.addEventListener("mouseenter", () => {
      ...
      tooltip.innerHTML = "🚧 <i class='fas fa-tools'></i> Coming Soon"; // Tooltip with emoji and icon
